 ...
 */
final class Version20251113210149 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE panier ADD id INT AUTO_INCREMENT NOT NULL, DROP PRIMARY KEY, ADD PRIMARY KEY (id)');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX `PRIMARY` ON panier');
        $this->addSql('ALTER TABLE panier DROP id');
        $this->addSql('ALTER TABLE panier ADD PRIMARY KEY (REF_COMMANDE, NUM_PRODUIT)');
