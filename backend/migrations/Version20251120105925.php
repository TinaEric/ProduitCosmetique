 ...
 */
final class Version20251120105925 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE commande CHANGE frais_livraison frais_livraison NUMERIC(10, 2) DEFAULT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE commande CHANGE frais_livraison frais_livraison VARCHAR(32) DEFAULT NULL');
