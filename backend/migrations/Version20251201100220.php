 ...
 */
final class Version20251201100220 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE commande CHANGE date_commande date_commande DATETIME DEFAULT NULL COMMENT \'(DC2Type:datetime_immutable)\', CHANGE date_update date_update DATETIME DEFAULT NULL COMMENT \'(DC2Type:datetime_immutable)\'');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE commande CHANGE date_commande date_commande DATE DEFAULT NULL, CHANGE date_update date_update DATE DEFAULT NULL');
    }
}
