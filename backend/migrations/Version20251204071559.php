 ...
 */
final class Version20251204071559 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE paiement CHANGE date_paiment date_paiment DATE DEFAULT NULL COMMENT \'(DC2Type:date_immutable)\'');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE paiement CHANGE date_paiment date_paiment DATE DEFAULT NULL');
