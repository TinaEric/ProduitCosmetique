 ...
 */
final class Version20251208192749 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX IDX_B1DC7A1EE8FD60FA ON paiement');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_B1DC7A1EE8FD60FA ON paiement (ref_commande)');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX UNIQ_B1DC7A1EE8FD60FA ON paiement');
        $this->addSql('CREATE INDEX IDX_B1DC7A1EE8FD60FA ON paiement (REF_COMMANDE)');
