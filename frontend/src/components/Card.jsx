    ...
    return (
        <div className="flex justify-evenly">
            <div
                ...
                key={id}
                className="relative m-4 max-h-[50rem] w-[160px] flex-1 space-y-3 bg-white shadow-lg shadow-slate-800 transition-all duration-200 hover:-translate-y-2 hover:shadow-xl hover:shadow-slate-900 dark:bg-[#0F172A] dark:shadow-black"
            >
                <img
                    ...
                    className="h-[150px] w-[160px] rounded-md object-cover"
                />
